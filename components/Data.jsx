      ...
      {myList?.length === 0 ? (
        ...
        <div className={Style.dataBox}>
          {myList?.map((el, index) => {
            ...
            return (
              <div key={index} className={Style.home_create_list_app}>
                  ...
                  {el.completed === false ? (
                    <div className={Style}>
                      ...
                      <p>
                        Delete:
                        <RiCloseFill
                          onClick={() => deleteToggle(el.userId)}
                        />{" "}
                      </p>
                      ...
                      {edit === index && (
                        <div>
                          ...
                          <button
                            ...
                            onClick={() =>
                              editMesssage(el.userId, editMessage.message)
                            }
                          >
                            Done Editing
                          </button>
                    ...
                    <div className={Style.done}>
                      ...
                      <RiCloseFill onClick={() => deleteToggle(el.userId)} />
                    </div>
                  )}
                </div>
              </div>
